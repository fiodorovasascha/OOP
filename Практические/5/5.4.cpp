...
string razn(string s1, string s2)
{
	int pos1 = s1.find(s2);
...
int del(int a, int b) {
	if (b == 0) {
		cout << "Данное действие невозможно";
	}
	else {
		return a / b;
	}
...
int main()
{
	...
	cout << "Вычитание = " << razn(i_a, i_b) << endl;
	cout << "Умножение = " << umnoj(i_a, i_b) << endl;
	cout << "Деление = " << del(i_a, i_b) << endl<<endl;

	cout << "Для чисел " << d_a << " и " << d_b << " типа double: " << endl;
	cout << "Сложение = " << summ(d_a, d_b) << endl;
	cout << "Вычитание = " << razn(d_a, d_b) << endl;
	cout << "Умножение = " << umnoj(d_a, d_b) << endl;
	cout << "Деление = " << del(d_a, d_b) << endl<<endl;

	cout << "Для строк " <<s_a<<" и " <<s_b<<" типа string: " << endl;
	cout << "Сложение = " << summ(s_a, s_b) << endl;
	cout << "Вычитание = " << razn(s_a, s_b) << endl;
	string ss = razn(s_a, s_b);
	cout << "Умножение " << ss << " на " << i_a << " = " << umnoj(ss, i_a) << endl << endl;

	cout << "Для символов " << c_a << " и " << c_b << " типа char: " << endl;
	cout << "Сложение = " << summ(c_a, c_b) << endl;
	cout << "Умножение "<<c_a<<" на "<<i_b<< " = " << umnoj(c_a, i_b) << endl<<endl;
